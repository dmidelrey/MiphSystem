...
<br><br>
 <div class="container-fluid">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">&nbsp;Изменить кол-во знаний :  <?php echo"".$rec['fname']."&nbsp;".$rec['lname'].""?></div>
                        ...
                        <div class="panel-body">
							...
							<br>
						        ...
						        <a button name="cancel" class="btn btn-primary" href="water.php">Выйти</a></button>
						    </div>
