                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
									...
									$kek = $_SESSION['username'];
													...
													$ui = mysql_query("select * from tenant WHERE tenant_id=$id")or die(mysql_error());
												...
												<tr>
												<td onClick='location.href="send.php?id=<?php echo $id; ?>"'><strong><?php echo $row1['fname']."&nbsp;".$row1['mname']; ?></strong></td>
												<td onClick='location.href="send.php?id=<?php echo $id; ?>"'><?php echo $row['mess'] ?></td>
												<td onClick='location.href="send.php?id=<?php echo $id; ?>"'><?php echo $row['date'] ?></td>
											</center>
