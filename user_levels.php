					  ...
					  <?php	
                       ...
                       ?>	
                        ...
                        <div id="block_bg" class="block">	
							...
							<br>
							&nbsp;&nbsp;&nbsp;
							<a button type='button' class="btn btn-primary" href="userlevels.php">Назад</a>
									...
									<div class="table-responsive">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php 
						$id=$_GET['id'];
						$query=mysql_query("SELECT tenant_id,fname,mname,lname FROM tenant WHERE level = $id")or die(mysql_error());
						while($row=mysql_fetch_array($query)){
						$id = $row['tenant_id'];
						?>
