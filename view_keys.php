...
<head>
  ...
  <link rel="shortcut icon" href="assets/img/calculator.png">
    ...
    <title>Все доступные коды регистрации</title>
    ...
    <div id="wrapper">
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
				<nav>
				<center><h4><strong>Доступные коды</strong><h4></center>
				<div class="col-sm-12">
				<div class="span7" id="">  
                     <div class="row-fluid">
					  <?php	
					   ...
					   <!-- Modal -->
						...
						if(isset($_POST['delete'])){
							...
							for($i=0; $i < $N; $i++)
							{
								$result = mysql_query("DELETE FROM unique_keys where id='$id[$i]'");
							}
							}
							?>
                        <!-- block -->						
                        <div id="block_bg" class="block">	
							...
							<a button type='button' class="btn btn-primary" href="registerpage.php">Назад</a>
							<a button type='button' class="btn btn-primary" href="registeruni.php">Добавить еще кодов</a>						
								...
								<form method="post">
									<div class="table-responsive">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php 
						$query=mysql_query("SELECT * FROM unique_keys")or die(mysql_error());
						...
						?>
												...
												<td><center><?php echo $row['key_value']; ?></center></td>	
							</tr>
												<?php } ?>
										</tbody>
									</table>
