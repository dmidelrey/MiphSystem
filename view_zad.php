...
<div id="page-wrapper">
            <div class="container-fluid">
				...
				<?
				$id = $_GET['id'];
				$query=mysql_query("SELECT zadacha1, text FROM zadachi WHERE zada_id = '$id'")or die(mysql_error());
				$row=mysql_fetch_array($query)?>
				<center><h4><strong><?php echo $row['zadacha1']; ?></strong></h4></center>
					   <div class="col-sm-12">
								...
								<!-----------------------form --------------------->
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										<tbody>	
												...
												<td><strong><?php echo $row['text']; ?><strong></td>
