						  ...
						  <div class="modal-dialog">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
							   Уверены что хотите удалить отряд? Отменить это действие будет невозможно
							  </div>
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
									...
									<?php
												...
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Click here to edit this room." href="edit_room.php<?php echo '?id='.$row['room_id'];?>">Изменить название</a></center></td>
											</center>
