...
<br><br>
 <div class="container-fluid">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading"><i class="fa fa-sitemap fa"></i>&nbsp;Добавить проект</div>
                            ...
                            <div class="table">
								<form method="post">
                                    <tbody>
									  ...
									  <div class="form-group input-group">
										<label class="col-sm-2 control-label">Наставник: Вы</label>
									   </div>
									   <div class="form-group input-group">
									  ...
									  <input type="text" class="form-control" id="auth" name="auth" placeholder="id ученика, логин или его уникальный код" required>
									  </div>
									  <div class="form-group input-group">
									  ...
									  <div class="col-md-3"><TEXTAREA class="form-control input-md" id="text" name="text" COLS="50" ROWS="10"  required></TEXTAREA>
									  	...
									  	<div class="form-group input-group">
										<label class="col-sm-2 control-label">Презентация</label>
