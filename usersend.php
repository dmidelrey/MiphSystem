...
<head>
  ...
  <link rel="shortcut icon" href="assets/img/calculator.png">
    ...
    <title>МИФ | <?php echo $row['fname']."&nbsp;".$row['lname']?></title>
    <link href="css/bootstrap.min.css" rel="stylesheet">
...
<input type="submit" value="Отправить" name="submit" class="btn btn-success"><BR>
					<br>
						...
						while($row = mysql_fetch_array($user_query)){
							...
							$ui = mysql_query("select * from admin WHERE admin_id=$idf")or die(mysql_error());
							$row1 = mysql_fetch_array($ui);
						?>
						<div style="margin-top:5px;" id="message_box">
												<strong><?php if ($row['to_id'] == $kek) { echo $row1['fname']."&nbsp;".$row1['lname']; } else { echo $_SESSION['fname']."&nbsp;".$_SESSION['mname']; } ?></strong><br><?php echo $row['mess'] ?><br>
