								...
								<!-----------------------form --------------------->
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										<tbody>	
												...
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Нажми сюда" href="tenant_logedit.php?id=<?php echo $row['zada_id']; ?>">Изменить лог</a></td></center>
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Нажми сюда" href="tenant_log.php?id=<?php echo $row['zada_id']; ?>">Просмотр лога</a></td></center></tr>
						<? }?>
