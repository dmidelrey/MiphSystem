                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="table">
							  ...
							  <?php 
									$id=$_GET['id'];
									$sql = "SELECT * FROM miphs WHERE miph_id='$id'";
									$qry = mysql_query($sql);
							...
							<br>
						        ...
						        <a button name="cancel" class="btn btn-primary" href="view_room.php">Выйти</a></button>
						    </div>
						...
						if (($_POST['room_name'] == ''))
						{
							...
							mysql_query("UPDATE miphs SET title ='$r' WHERE miph_id='$id'")or die(mysql_error()); 
					}?>
							<script>
							alert('Успешно');
