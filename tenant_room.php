...
<div id="page-wrapper">
            <div class="container-fluid">
				...
				<nav>
				<head>
				<center><h4><strong>В каком отряде</strong></h4></center>
					   <div class="col-sm-12">
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
									...
									<?php
												...
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Нажми на меня." href="view_tenant.php<?php echo '?id='.$row['room_id'];?>">Просмотр пребывающих</a></center></td>
											</center>
